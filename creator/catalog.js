(function(root,factory){const api=factory();if(typeof module==='object'&&module.exports)module.exports=api;if(root)root.I30Catalog=api;})(typeof window!=='undefined'?window:globalThis,function(){
  const CREATION_TYPES=[
    ...
    {id:'appIdea',label:'Ideia de aplicativo',icon:'▦',description:'MVP, funcionalidades, receita e prompt técnico.'},
    {id:'saas30',label:'30 ideias de SaaS',icon:'30',description:'Motor original com score, ranking e melhor oportunidade.'},
